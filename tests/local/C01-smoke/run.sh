...
printf '{"schema_version":1,"case":"C01-smoke","run_id":"%s","passed":false,"terminal_code":"not_implemented","reason":"relay reservation or exact probe did not complete","artifacts":["exchange.ndjson","server.ndjson","client.ndjson"]}\n' "$RUN_ID" >"$OUT/summary.json"
cat "$OUT/summary.json"
exit 2
